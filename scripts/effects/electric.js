const elecEffect = newEffect(30, e => {
  /* Java version
...
const electric = new StatusEffect("electric");
  electric.damageMultiplier = 1;
  electric.speedMultiplier = 0;
  electric.armorMultiplier = 0;
  electric.damage = 1.5;
  electric.color = Color.valueOf("D4F2FB");
  electric.effect = elecEffect;
